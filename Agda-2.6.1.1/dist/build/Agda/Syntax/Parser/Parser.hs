...
happyReduction_283 (happy_x_2 `HappyStk`
	happy_x_1 `HappyStk`
	happyRest) tk
	 = happyThen ((case happyOut45 happy_x_2 of { happy_var_2 -> 
	( do
      p <- exprToLHS (RawApp (getRange happy_var_2) happy_var_2);
      return LamClause{ lamLHS      = p [] []
                      , lamRHS      = AbsurdRHS
...
happyReduction_389 (happy_x_7 `HappyStk`
	...
	case happyOut184 happy_x_7 of { happy_var_7 -> 
	happyIn111
...
happyReduction_392 (happy_x_7 `HappyStk`
	...
	case happyOut42 happy_x_5 of { happy_var_5 -> 
	case happyOutTok happy_x_6 of { (TokKeyword KwWhere happy_var_6) -> 
	case happyOut178 happy_x_7 of { happy_var_7 -> 
...
happyReduction_510 (happy_x_3 `HappyStk`
	...
	happy_x_1 `HappyStk`
	happyRest) tk
	 = happyThen ((case happyOut179 happy_x_2 of { happy_var_2 -> 
...
happyReduction_512 (happy_x_3 `HappyStk`
	...
	happy_x_1 `HappyStk`
	happyRest) tk
	 = happyThen ((case happyOut185 happy_x_2 of { happy_var_2 -> 
...
exprParser = happySomeParser where
 happySomeParser = happyThen (happyParse 1#) (\x -> happyReturn (happyOut42 x))
